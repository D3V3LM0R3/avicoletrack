...
from sqlalchemy import Date, ForeignKey, Integer, String, Float, Text
...
class DailyReport(Base):
    ...
    flock_id: Mapped[int | None] = mapped_column(ForeignKey("flocks.id", ondelete="SET NULL"), nullable=True)
